...
namespace ProcessarPedidoPago
{
    ...
    {
        private readonly IProcessarPedidoPago _processarPedidoPago;
        ...
        public Function()
        {
            ...
            serviceCollection.AddScoped<IProcessarPedidoPago, ProcessarPedidoPago.Services.ProcessarPedidoPago>();
